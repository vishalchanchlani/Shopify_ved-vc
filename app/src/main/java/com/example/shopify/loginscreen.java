...
//import com.example.shopify.loginscreen.Register;
...
public class loginscreen extends AppCompatActivity {
    ...
    public void LoginFunction(){
        ...
        if(EditTextEmptyHolder) {
            ...
            Toast.makeText(loginscreen.this,"Please Enter UserName or Password.",Toast.LENGTH_LONG).show();
        }
    ...
    public void CheckFinalResult(){
        ...
        if(TempPassword.equalsIgnoreCase(PasswordHolder))
        {
            ...
            Intent intent = new Intent(loginscreen.this, productpage.class);
